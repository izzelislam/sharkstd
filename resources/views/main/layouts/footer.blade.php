<footer class="section-footer bg-dark position-relative">
            ...
            <div class="row pb-3">
                <aside class="col-md-2">
                    <div class="footer-logo">
                        <img src="/main_assets/logo_type_white.png" width="70%" alt="logo">
                    </div>
                </aside>
                <aside class="col-md">
    ...
    <section class="footer-bottom border-top border-dark white pt-4">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <span class="pr-2">© {{ date("Y") }} Shark-Std.</span>
                    <span class="pr-2"><a href="#">Privacy policy</a></span>
                    <span class="pr-2"><a href="#">Terms of use</a></span>
                </div>
                <div class="col-md-6 text-md-right">
                    {{-- <a href="#" class="mr-2"><img src="/main/assets/img/payment/footer-visa.svg" width="42"></a> --}}
                    {{-- <a href="#" class="mr-2"><img src="/main/assets/img/payment/footer-mastercard.svg" width="42"></a> --}}
                    <a href="#"><img src="/main/assets/img/payment/footer-paypal.svg" width="42"></a>
                </div>
            </div>
            <!-- row.// -->
        </div>
