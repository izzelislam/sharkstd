        ...
        <div class="page-container">
                  ...
                  <div class="" id="navbarNav">
                    ...
                    <div class="" id="headerNav">
                      <ul class="navbar-nav">
                              ...
                              <div class="header-notif">
                                <div class="notif-image">
                                  <span class="notification-badge">
                                    <img src="/admin/assets/images/avatars/profile-image.png" alt="">
                                  </span>
                                </div>
                                <div class="notif-text">
                                  <p>faucibus dolor in commodo lectus mattis</p>
                        ...
                        <li class="nav-item dropdown">
                          <a class="nav-link profile-dropdown" href="#" id="profileDropDown" role="button" data-bs-toggle="dropdown" aria-expanded="false"><img src="/admin/assets/images/avatars/profile-image.png" alt=""></a>
            ...
            <div class="page-content">
                      ...
                      <div class="card table-widget">
                          <div class="card-body">
                              ...
                              <table class="table">
                                ...
                                <tbody>
                                  <tr>
                                    <th scope="row"><img src="/admin/assets/images/avatars/profile-image.png" alt="">Anna Doe</th>
                                    <td>Modern</td>
                                    <td>#53327</td>
                                    <td>$20</td>
                                  ...
                                  <tr>
                                    <th scope="row"><img src="/admin/assets/images/avatars/profile-image.png" alt="">John Doe</th>
                                    <td>Alpha</td>
                                    <td>#13328</td>
                                    <td>$25</td>
                                  ...
                                  <tr>
                                    <th scope="row"><img src="/admin/assets/images/avatars/profile-image.png" alt="">Nina Doe</th>
                                    <td>Space</td>
                                    <td>#54773</td>
                                    <td>$20</td>
                                    <td><span class="badge bg-success">Paid</span></td>
              ...
              <div class="row">
                ...
                <div class="col-md-12 col-lg-4">
                  <div class="card">
                    <img src="/admin/assets/images/card-bg.png" class="card-img-top" alt="...">
                    <div class="card-body">
