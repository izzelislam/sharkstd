            ...
            Column::make('Action')
                ->label(
                    fn ($row, Column $column) => view('components.livewire.datatable-action-column')->with(
                        [
                            'detail' => route("bo.admins.show", Crypt::encryptString($row->id)),
                            'edit'   => route("bo.admins.edit", Crypt::encryptString($row->id)),
                            'delete' => route("bo.admins.destroy", Crypt::encryptString($row->id)),
                        ]
                    )
                )->html()
